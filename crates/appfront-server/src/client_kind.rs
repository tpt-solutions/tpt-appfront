...
/// - [`Crawler`](ClientKind::Crawler) → semantic HTML via `appfront-html`.
/// - [`AiAgent`](ClientKind::AiAgent) → JSON-LD + AI Schema via `appfront-ai-schema`.
/// - [`SocialBot`](ClientKind::SocialBot) → OpenGraph meta tags via `appfront-html`.
