...
/// Parses an IPC message, checks the ACL (action grant + argument contract)
/// and rate limit, and dispatches to `on_command`. Retained for the unit tests
/// and as a standalone dispatch primitive.
#[allow(dead_code)]
